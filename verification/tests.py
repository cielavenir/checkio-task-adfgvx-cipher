...
BASIC_TESTS = [
    ...
    ['encode("attack at 12:00 am", "na1c3h8tb2ome5wrpd4f6g7i9j0kjqsuvxyz", "privacy")', 'DGDDAXDGAADDDADDVDAD'],
    ['decode("DGDDAXDGAADDDADDVDAD", "na1c3h8tb2ome5wrpd4f6g7i9j0kjqsuvxyz", "privacy")', 'attackatam'],
...
ENCODE_TESTS = [
    [
        ...
        'AXADXXGAXVXXDFXXGAFAGVXXGXGDFDVAXFXXXAVXDXXXDXXXFVAXVXDFXAFAAGVAXGDXAAAVFAXGGFXX'],
    [
    ...
    [
        ...
        'XGAGFVXDFVXDAVAGFXVXDXDFVVXDGFXXDVXFDFDAXAXGAAGVAFADFXXDVAFFFFFFXXXFAFFAFXGFFVXDDFDFFVXVAVGDXFFXGVGVXGDAFFDVVVGD'],
    [
...
DECODE_TESTS = [
    [
        'decode("DGVAVDFXDDVXFFAGAXFXVXXGFDDXFGDAAGVVAFAVXVFGFFXVFXFGAAFVVVVGFAFXXGGGGXFGXAVFFAFA", "yozmhbrk3085691qlixje2w7dcustavpn4fg", "yep")',
    ...
    [
        'decode("XDXDDVDDGXADDFDDDAVADXDGVXVGADADAXXDGXGAXDDFFGXXXGDAXAVGXXXGGGGGGXGGGGXXGADGXXFGXXXXGVAXDFFDAXVVFVFXXFGDGXGXXFFD", "gy3zul5j8ntkbhf610verc7ix2wq49dsapom", "checkio")',
